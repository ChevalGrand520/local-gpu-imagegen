...
`dist/local_gpu_imagegen-0.9.1-py3-none-any.whl`. Do not rebuild it during this
verification.
...
$wheel = Resolve-Path .\dist\local_gpu_imagegen-0.9.1-py3-none-any.whl
