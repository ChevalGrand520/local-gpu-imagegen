...
Status: implemented and frozen for the current local-gpu-imagegen 0.9.1
...
outside the 0.9.1 target; it is not part of the current 0.9.1
candidate contract.
...
proxy before retrying. The current 0.9.1 candidate does not silently switch to
a mirror.
